...
use dew_cond::cranelift as cond;
...
fn compile_ast_int(
    ...
    match ast {
        ...
        Ast::Compare(op, left, right) => {
            ...
            let r = compile_ast_int(right, builder, vars, math)?;
            let cc = match op {
                dew_core::CompareOp::Lt => IntCC::SignedLessThan,
                dew_core::CompareOp::Le => IntCC::SignedLessThanOrEqual,
                dew_core::CompareOp::Gt => IntCC::SignedGreaterThan,
                dew_core::CompareOp::Ge => IntCC::SignedGreaterThanOrEqual,
                dew_core::CompareOp::Eq => IntCC::Equal,
                dew_core::CompareOp::Ne => IntCC::NotEqual,
            };
