...
//!
//! ```
//! use dew_scalar::{ScalarFn, FunctionRegistry, scalar_registry};
//!
//! struct Double;
...
//! ```
//! use dew_core::Expr;
//! use dew_scalar::{eval, scalar_registry, FunctionRegistry};
//! use std::collections::HashMap;
//!
